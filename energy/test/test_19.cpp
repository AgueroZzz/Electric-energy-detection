...
test_19::test_19(quint16 test_id, QWidget *parent)
    : test(test_id, parent)
{
    init_UI();
...
void test_19::init_top_widget()
{
    ...
    _btn_error_in     = createToolButton(":/icon/icon/gz.svg", "开始故障");
    _btn_error_recover = createToolButton(":/icon/icon/recover.svg", "供电恢复");
    ...
    btn_layout->addWidget(_btn_error_recover);
