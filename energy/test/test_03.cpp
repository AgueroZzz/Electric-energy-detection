...
{
    _ac = new ac_chart(_ui_003->ac_map);
    _dc = new dc_chart(_ui_003->dc_map);
    ...
    QObject::connect(_ui_003, &ui_003::sig_charts_refresh, this, &test_03::slot_charts_refresh);
}

void test_03::init_state_widget()
{
...
void test_03::slot_charts_refresh()
{
    _ac->slot_charts_refresh(_ui_003->ac_map);
    _dc->slot_charts_refresh(_ui_003->dc_map);
}

void test_03::slot_test_start()
{
