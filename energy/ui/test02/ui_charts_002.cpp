#include "ui_charts_002.h"

ui_charts_002::ui_charts_002(QWidget *parent)
...
void ui_charts_002::slot_update_chart(const QVector<double> &values)
{
    if (values.size() != 6) {
