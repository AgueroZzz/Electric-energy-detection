#ifndef AC_I_U_TWELVE_CHART_H
#define AC_I_U_TWELVE_CHART_H
...
class ac_i_u_twelve_chart : public QWidget
{
    Q_OBJECT
public:
    explicit ac_i_u_twelve_chart(const QMap<QString, QList<QVariant>>& initialMap = {},
...
private:
    ...
    const QVector<double> _scaleLevels {150, 120, 90, 50, 30, 10};

    bool _showGridCircles = true;
    bool _showAxes = true;

    int _mode = 0;   // 0:相/线分量  1:序分量

private:
    void initAllPhasors();

    // 从输入map解析 UA/UB/UC/Ua/Ub/Uc/IA/IB/IC/Ia/Ib/Ic / Uo/U+/U-/uo/u+/u-
